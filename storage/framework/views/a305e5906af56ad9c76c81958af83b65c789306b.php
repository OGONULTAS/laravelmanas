<?php $__env->startSection('title-page', '奥森图标'); ?>
            ...
            <div class="m-portlet__body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="m-demo-icon">
                            <div class="m-demo-icon__preview">
                                <i class="fa fa-y-combinator-square">
                                </i>
                            </div>
                            <div class="m-demo-icon__class">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="m-demo-icon">
                            <div class="m-demo-icon__preview">
                                <i class="fa fa-odnoklassniki-square">
                                </i>
                            </div>
                            <div class="m-demo-icon__class">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="m-demo-icon">
                            <div class="m-demo-icon__preview">
                                <i class="fa fa-asl-interpreting">
                                </i>
                            </div>
                            <div class="m-demo-icon__class">
                                fa-asl-interpreting
