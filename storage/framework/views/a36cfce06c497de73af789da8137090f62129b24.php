            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold ">Satış Geçmişi <small>(<?php echo e($scari4->ISIM); ?>)</small></span>
                    </div>
                    <div class="tools"></div>
                </div>
                <div class="portlet-body">
                    <input type="hidden" class="form-control" id="carikod" name="carikod" value="<?php echo e($scari1[0]->STHAR_CARIKOD); ?>">
        ...
        <div style="-webkit-column-break-before: 0" class="widget-row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="dashboard-stat green">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup" data-value="<?php echo e(number_format($scari2->BORC)); ?>">0</span> ₺</div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="dashboard-stat green">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup" data-value="<?php echo e(number_format($satis2018)); ?>">0</span> ₺</div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="dashboard-stat green">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup" data-value="<?php echo e(number_format($satis)); ?>">0</span> ₺</div>
                ...
                <div class="col-md-6 ">
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                <i class="icon-notebook font-dark"></i>
                                <span class="caption-subject bold ">Açık Siparişleri <small>(<?php echo e($scari4->ISIM); ?>)</small></span>
                            </div>
                            <div class="tools"></div>
                        </div>
                        <div class="portlet-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#sample_1').DataTable({
                ...
                serverSide: true,
                    "ajax": {
                        "url": '<?php echo e(url('tablecarilist')); ?>'+'/' + '<?php echo e($scari1[0]->STHAR_CARIKOD); ?>'
                            },
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#aciksip').DataTable({
                ...
                serverSide: true,
                "ajax": {
                    "url": '<?php echo e(url('tablecariaciklist')); ?>'+'/' + '<?php echo e($scari1[0]->STHAR_CARIKOD); ?>'
                },
