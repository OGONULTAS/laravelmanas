<?php $__env->startSection('title-page', '扁平图标'); ?>
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="m-demo-icon">
                                <div class="m-demo-icon__preview">
                                    <i class="flaticon-exclamation-square">
                                    </i>
                                </div>
                                <div class="m-demo-icon__class">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="m-demo-icon">
                                <div class="m-demo-icon__preview">
                                    <i class="flaticon-search-magnifier-interface-symbol">
                                    </i>
                                </div>
                                <div class="m-demo-icon__class">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="m-demo-icon">
                                <div class="m-demo-icon__preview">
                                    <i class="flaticon-speech-bubble">
                                    </i>
                                </div>
                                <div class="m-demo-icon__class">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="m-demo-icon">
                                <div class="m-demo-icon__preview">
                                    <i class="flaticon-placeholder-2">
                                    </i>
                                </div>
                                <div class="m-demo-icon__class">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="m-demo-icon">
                                <div class="m-demo-icon__preview">
                                    <i class="flaticon-placeholder-1">
                                    </i>
                                </div>
                                <div class="m-demo-icon__class">
