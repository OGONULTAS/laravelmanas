var LayoutBuilder = function() {
    var e = function() {
            $("#builder_export_html").click(function(e) {
                e.preventDefault();
                var t = $(this);
                $("#builder_export").addClass("m-loader m-loader--light m-loader--right").find("> span > span").text("Exporting...").closest(".m-form__actions").find(".btn").prop("disabled", !0), $("<iframe/>").attr({
        ...
        t = function() {
            $("#builder_export_html_static").click(function(e) {
                e.preventDefault();
                var t = $(this);
                $("#builder_export").addClass("m-loader m-loader--light m-loader--right").find("> span > span").text("Exporting...").closest(".m-form__actions").find(".btn").prop("disabled", !0), $.notify({
