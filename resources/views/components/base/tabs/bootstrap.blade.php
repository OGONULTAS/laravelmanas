...
@section('title-page', 'Bootstrap tabs')

@section('sub_header_title1', '基础Base')
@section('sub_header_title2', 'Tabs标签')
            ...
            <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item dropdown">
                            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                                <i class="la la-exclamation-circle m--font-success">
                                </i>
                                Dropdown
                            </a>
                            <div class="dropdown-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                                <i class="la la-puzzle-piece m--font-danger">
                                </i>
                                Link 2
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item dropdown">
                            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                                <i class="flaticon-time-2 m--font-success">
                                </i>
                                Dropdown
                            </a>
                            <div class="dropdown-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                                <i class="flaticon-lock m--font-danger">
                                </i>
                                Link 2
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item dropdown">
                            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                                <i class="fa fa-file-powerpoint-o m--font-success">
                                </i>
                                Dropdown
                            </a>
                            <div class="dropdown-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                                <i class="fa fa-comment m--font-brand">
                                </i>
                                Link 2
                            </a>
                        </li>
