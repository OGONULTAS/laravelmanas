...
@section('title-page', 'Bootstrap通知框')
        ...
        <form class="m-form m-form--fit m-form--label-align-right">
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input data-on-color="brand" data-switch="true" id="m_notify_url" type="checkbox">
                        </input>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input checked="" data-on-color="brand" data-switch="true" id="m_notify_dismiss" type="checkbox">
                        </input>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input data-on-color="brand" data-switch="true" id="m_notify_pause" type="checkbox">
                        </input>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input data-on-color="brand" data-switch="true" id="m_notify_top" type="checkbox">
                        </input>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input data-on-color="brand" data-switch="true" id="m_notify_title" type="checkbox">
                        </input>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input data-on-color="brand" data-switch="true" id="m_notify_progress" type="checkbox">
                        </input>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input class="form-control" id="m_notify_spacing" type="number" value="10"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input class="form-control" id="m_notify_offset_x" type="number" value="30"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input class="form-control" id="m_notify_offset_y" type="number" value="30"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input class="form-control" id="m_notify_delay" type="number" value="1000"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input class="form-control" id="m_notify_timer" type="number" value="2000"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input class="form-control" id="m_notify_zindex" type="number" value="10000"/>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">
                ...
                <div class="m-form__actions m-form__actions">
                    <div class="row">
                        <div class="col-lg-9 ml-lg-auto">
                            <a class="btn btn-success" href="javascript:;" id="m_notify_btn">
                                Display
                            </a>
...
@section('link-js')
<script src="{{ url('assets/demo/default/custom/components/base/bootstrap-notify.js') }}" type="text/javascript"></script>
@stop