                            ...
                            <div class="m-demo" data-code-html="true" data-code-js="false" data-code-preview="true">
                                <div class="m-demo__preview">
                                    <ul class="m-nav">
                                        ...
                                        <li class="m-nav__item">
                                            <a class="m-nav__link" href="">
                                                <i class="m-nav__link-icon flaticon-cogwheel-2">
                                                </i>
                                                <span class="m-nav__link-text">
                                                    Settings
                                                </span>
                            ...
                            <div class="m-demo" data-code-html="true" data-code-js="false" data-code-preview="true">
                                <div class="m-demo__preview">
                                    <ul class="m-nav">
                                        ...
                                        <li class="m-nav__item">
                                            <a class="m-nav__link" href="">
                                                <i class="m-nav__link-icon flaticon-interface-1">
                                                </i>
                                                <span class="m-nav__link-text">
                                                    Logs
                                                </span>
                                ...
                                <div class="m-demo__preview">
                                    <div class="m-nav-grid">
                                        <div class="m-nav-grid__row">
                                            ...
                                            <a class="m-nav-grid__item" href="#">
                                                <i class="m-nav-grid__icon flaticon-user">
                                                </i>
                                                <span class="m-nav-grid__text">
                                                    Add Member
                                                </span>
                                        ...
                                        <div class="m-nav-grid__row">
                                            ...
                                            <a class="m-nav-grid__item" href="#">
                                                <i class="m-nav-grid__icon flaticon-interface-3">
                                                </i>
                                                <span class="m-nav-grid__text">
                                                    Check Logs
                                                </span>
