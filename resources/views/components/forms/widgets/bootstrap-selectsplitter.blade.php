...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            Metronic | Bootstrap Select Splitter
        </title>
        <meta name="description" content="Bootstrap select splitter examples">
...
<!--        <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js"></script>
    ...
    data-dropdown-toggle="click" data-dropdown-persistent="true" id="m_quicksearch" data-search-type="dropdown">
        ...
        <script src="../../../assets/demo/default/custom/components/forms/widgets/bootstrap-selectsplitter.js" type="text/javascript"></script>
        <!--end::Page Resources -->
    </body>
    <!-- end::Body -->
</html>
