                                    ...
                                    <form class="m-form">
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group has-warning">
                                                <label class="form-control-label" for="inputWarning1">
                                                    Input with warning
                                                </label>
                                    ...
                                    <form class="m-form m-form--state">
                                        <div class="m-portlet__body">
                                            <div class="form-group m-form__group m--margin-top-10">
                                                ...
                                                class to the form element to highlight form control borders on validation states change.
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group has-success">
                                            <label class="form-control-label" for="inputSuccess1">
                                ...
                                <form class="m-form">
                                    <div class="m-portlet__body">
                                        <div class="form-group m-form__group has-success row">
                                            <label class="col-form-label col-lg-3" for="inputSuccess1">
                                                Input with success
                                            </label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control form-control-success m-input" id="inputSuccess1">
                                        ...
                                        <div class="form-group m-form__group has-warning row">
                                            <label class="col-form-label col-lg-3" for="inputWarning1">
                                                Input with warning
                                            </label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control form-control-warning m-input" id="inputWarning1">
                                        ...
                                        <div class="form-group m-form__group has-danger row">
                                            <label class="col-form-label col-lg-3" for="inputDanger1">
                                                Input with danger
                                            </label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control form-control-danger m-input" id="inputDanger1">
