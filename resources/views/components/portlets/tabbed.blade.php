                                            ...
                                            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand  m-tabs-line--right m-tabs-line-danger" role="tablist">
                                                ...
                                                <li class="nav-item dropdown m-tabs__item">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_portlet_tab_2_2">
                                                            Action
                                                        </a>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_portlet_tab_2_3">
                                                            Another action
                                                        </a>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_portlet_tab_2_2">
                                                            Something else here
                                        ...
                                        <div class="m-portlet__head-tools">
                                            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--right m-tabs-line--danger" role="tablist">
                                                ...
                                                <li class="nav-item dropdown m-tabs__item">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_portlet_tab_3_2">
                                                            Action
                                                        </a>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_portlet_tab_3_3">
                                                            Another action
                                                        </a>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_portlet_tab_3_1">
                                                            Something else here
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_portlet_tab_3_3">
                                        ...
                                        <div class="m-portlet__head-tools">
                                            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand  m-tabs-line--right m-tabs-line-danger" role="tablist">
                                                ...
                                                <li class="nav-item dropdown m-tabs__item">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_tabs_8_2">
                                                            Action
                                                        </a>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_tabs_8_3">
                                                            Another action
                                                        </a>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_tabs_8_2">
                                                            Something else here
                                            ...
                                            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand  m-tabs-line--right m-tabs-line-danger" role="tablist">
                                                ...
                                                <li class="nav-item dropdown m-tabs__item">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_tabs_9_3">
                                                            Another action
                                                        </a>
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_tabs_9_2">
                                                            Something else here
                                        ...
                                        <div class="m-portlet__head-tools">
                                            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand  m-tabs-line--right m-tabs-line-danger" role="tablist">
                                                ...
                                                <li class="nav-item dropdown m-tabs__item">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" data-toggle="tab" href="#m_tabs_10_2">
                                                            Action
                                                        </a>
