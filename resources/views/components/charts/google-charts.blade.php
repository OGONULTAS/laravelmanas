...
<!--        <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js"></script>
    ...
    data-dropdown-toggle="click" data-dropdown-persistent="true" id="m_quicksearch" data-search-type="dropdown">
        ...
        For more info please check out
                                <a class="m-link m-link--warning m--font-bold" href="https://google-developers.appspot.com/chart/interactive/docs/quick_start" target="_blank">
        ...
        <script src="../../assets/demo/default/custom/components/charts/google-charts.js" type="text/javascript"></script>
        <!--end::Page Resources -->
    </body>
    <!-- end::Body -->
</html>
