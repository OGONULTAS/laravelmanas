...
@endif
    ...
    <div class="row widget-row">
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading"> {{$datetime}} Satış</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-green fa fa-try"></i>
                    <div class="widget-thumb-body">
                         <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{number_format($q7)}}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">{{$ay}}.AY SATIŞ</h4>
                <div class="widget-thumb-wrap">
                    <a href="#" class="widget-thumb-icon bg-red fa fa-try"></a>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{number_format($q6)}}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">{{$datetime1}}. HAFTA SATIŞ</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-purple fa fa-try"></i>
                    <div class="widget-thumb-body">

                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{number_format($q5)}}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-body-stat" data-counter="counterup"
                              data-value="@if (empty($q4[0]->TOPLAM))
                                      0
                                @else
                              {{number_format($q4[0]->TOPLAM)}}
                              @endif">0</span>
                    </div>
                </div>
            </div>
            ...
            <div class="display">
                <div class="number">
                    <h3 class="font-green-sharp">
                        <span data-counter="counterup" data-value="{{number_format($q14[0]->UZUNKREDI)}}">0</span>
                ...
                <div class="icon">
                    ...
                    <i style="color: green">%{{number_format($q17[0]->UZUN,2,',','.')}}</i>
                    @elseif($q17[0]->UZUN <0)
                    <i style="color: red" class="icon-arrow-up"></i> <br>
                    <i style="color: red">%{{number_format($q17[0]->UZUN,2,',','.')}}</i>
                    @elseif($q17[0]->UZUN ==0)
                    <i style="color: #b18d00" class="icon-arrow-right"></i> <br>
                    <i style="color: #b18d00">%{{number_format($q17[0]->UZUN,2,',','.')}}</i>
                    @endif
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat2 ">
                <div class="display">
                    <div class="number">
                        <h3 class="font-green-sharp">
                            <span data-counter="counterup" data-value="{{number_format($q14[0]->KISAKREDI)}}">0</span>
                            <small class="font-green-sharp">TL</small>
                        </h3>
                    ...
                    <div class="icon">
                        @if($q17[0]->KISA >0)
                            <i style="color: green" class="icon-arrow-down"></i> <br>
                            <i style="color: green">%{{number_format($q17[0]->KISA,2,',','.')}}</i>

                        @elseif($q17[0]->KISA <0)
                            <i style="color: red" class="icon-arrow-up"></i> <br>
                            <i style="color: red">%{{number_format($q17[0]->KISA,2,',','.')}}</i>

                        @elseif($q17[0]->KISA ==0)
                            <i style="color: #b18d00" class="icon-arrow-right"></i> <br>
                            <i style="color: #b18d00">%{{number_format($q17[0]->KISA,2,',','.')}}</i>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="dashboard-stat2 ">
                <div class="display">
                    <div class="number">
                        <h3 class="font-green-sharp">
                            <span data-counter="counterup" data-value="{{number_format($q14[0]->UZUNKREDI+$q14[0]->KISAKREDI)}}">0</span>
                            <small class="font-green-sharp">TL</small>
                        </h3>
                    ...
                    <div class="icon">
                        @if($q17[0]->TOPLAM >0)
                            <i style="color: green" class="icon-arrow-down"></i> <br>
                            <i style="color: green">%{{number_format($q17[0]->TOPLAM,2,',','.')}}</i>
                        @elseif($q17[0]->TOPLAM <0)
                            <i style="color: red" class="icon-arrow-up"></i> <br>
                            <i style="color: red">%{{number_format($q17[0]->TOPLAM,2,',','.')}}</i>
                        @elseif($q17[0]->TOPLAM ==0)
                            <i style="color: #b18d00" class="icon-arrow-right"></i> <br>
                            <i style="color: #b18d00">%{{number_format($q17[0]->TOPLAM,2,',','.')}}</i>
                        @endif
                            <br><small style="color: black;font-size: 85%">2 Hafta</small>
                    </div>
                </div>
    ...
    <div style="-webkit-column-break-before: 0" class="row widget-row">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q12_1)}}">0</span> €</div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q12_2)}}">0</span> $</div>
                    <div class="desc">Toplam Stok Durumu </div>
                </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q12)}}">0</span> ₺</div>
                    <div class="desc">Toplam Stok Durumu</div>
                </div>
   ...
   {{-- <div class="col-md-12">
        <div id="chartdiv1" style="width: 100%; height: 400px;border-radius: 20px; ">
        </div>
    </div>--}}
    ...
    <div class="col-md-12">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat yellow">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q8[0]->ALACAK)}}">0</span> ₺</div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat yellow">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q8[0]->VADE)}}">0</span> ₺</div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="dashboard-stat yellow">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q9[0]->ALACAK)}}">0</span> ₺</div>
        ...
        <div class="portlet-body">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat yellow">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup" data-value="{{number_format($q8[0]->ALACAK)}}">0</span> ₺
                        </div>
                        <div class="desc"> Toplam Borç </div>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->FAIZBANKA)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->PERSONELUCRET)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->MESAI)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->YEMEK)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->ARACKIRA)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->AKARYAKIT)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->PSERVIS)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->DOGALGAZ)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->ELEKTRIK)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->SU)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->HABERLESME)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->TAZMINAT)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->AGIRLAMA)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->KIRA)}}">0</span> ₺</div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{number_format($q15[0]->STJ)}}">0</span> ₺</div>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat2 ">
                <div class="display">
                    <div class="number">
                        <h3 class="font-green-sharp">
                            <span data-counter="counterup" data-value="{{number_format($q16[0]->GELIR)}}">0</span>
                            <small class="font-green-sharp">TL</small>
                        </h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat2 ">
                <div class="display">
                    <div class="number">
                        <h3 class="font-green-sharp">
                            <span data-counter="counterup" data-value="{{number_format($q16[0]->GIDER600+$q16[0]->GIDER700)}}">0</span>
                            <small class="font-green-sharp">TL</small>
                        </h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat2 ">
                <div class="display">
                    <div class="number">
                        <h3 class="font-green-sharp">
                            <span data-counter="counterup" data-value="{{number_format($q16[0]->SMM)}}">0</span>
                            <small class="font-green-sharp">TL</small>
                        </h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat2 ">
                <div class="display">
                    <div class="number">
                        @if ($q16[0]->GELIR-($q16[0]->GIDER600+$q16[0]->GIDER700+$q16[0]->SMM) < 0)
                            <h3 class="font-red">
                                <span data-counter="counterup" data-value="{{number_format($q16[0]->GELIR-($q16[0]->GIDER600+$q16[0]->GIDER700+$q16[0]->SMM))}}">0</span>
                 ...
                 <div class="form-group">
                     <div class="input-group select2-bootstrap-append select2-bootstrap-prepend input-large">
                         <select class="form-control select2">
                             @foreach($q1 as $data)
                             <option>{{$data->CARI_ISIM}}</option>
                             @endforeach
                         </select>
                     </div>
                 </div>
                 <button type="submit" id="mybutton" class="btn green">Transfer cash</button>
             </form>
         </div>
     </div>
     </div>
   ...
   $("#chart_1").closest(".portlet").find(".fullscreen").click(function(){e.invalidateSize()})
    ...
    <script type="text/javascript">
        AmCharts.makeChart("chart_2",{type:"serial",theme:"light",pathToImages:App.getGlobalPluginsPath(),autoMargins:!1,marginLeft:30,marginRight:8,marginTop:10,marginBottom:26,fontFamily:"Open Sans",color:"#888",
            dataProvider:[
                    @foreach ($q10 as $data2)
                {
                    "year": "{{$data2->TARIH}}",
                    "income": "{{$data2->Y2018}}",
                    "expenses": "{{$data2->Y2017}}"
                },
                @endforeach
            ],
            valueAxes:[{axisAlpha:0,position:"left"}],startDuration:1,graphs:[{alphaField:"alpha",
